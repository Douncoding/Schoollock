...
import com.douncoding.schoollock.lock.LockServiceManager;
...
public class HomeActivity extends BaseActivity implements HasComponent<HomeComponent>,
    ...
    public void initUiAndListener() {
        ...
        this.navigator.navigateToLockService(this);
    ...
    public void onRollbookClicked() {
        LockServiceManager.appLockStart(this);
//        navigator.navigateToRollbook(this);
    }

    @Override
    public void onNoticeClicked() {
        LockServiceManager.appLockStop(this);
